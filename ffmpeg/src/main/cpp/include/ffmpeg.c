...
#include "ffmpeg.h"
#include "cmdutils.h"
#define LOGD(...) __android_log_print(ANDROID_LOG_DEBUG  , "JNIT_TAG", __VA_ARGS__)
#define LOGE(...) __android_log_print(ANDROID_LOG_ERROR  , "JNIT_ERROR", __VA_ARGS__)
...
int ffmpeg_exec(int argc, char **argv,void(call_back)(int,int)) {
    int i, ret;
