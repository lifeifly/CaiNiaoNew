...
class SocietyRvAdapter(context: Context) : BaseBindingAdapter<ListBean, BaseViewHolder>(context) {
    ...
    override fun onBindVH(holder: BaseViewHolder, position: Int) {
        Log.d("TAG","1")
        holder.binding.setVariable(BR.listbean,mDataList.get(position))
