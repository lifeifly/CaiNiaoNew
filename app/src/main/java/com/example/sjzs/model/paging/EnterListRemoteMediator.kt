...
class EnterListRemoteMediator(
    private val query: String,
    private val category: String,
    private val database: ListBeanDatabase,
    private val apiService: ApiService
) : RemoteMediator<Int, EntertainmentList>() {
    private val listBeanDao = database.enterListDao()
    ...
    override suspend fun load(
        loadType: LoadType,
        state: PagingState<Int, EntertainmentList>
    ): MediatorResult {
        return try {
            ...
            val response = apiService.getEntertainmentData(category, "${loadKey}")
