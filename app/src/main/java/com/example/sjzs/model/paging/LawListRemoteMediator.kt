...
import com.example.sjzs.model.bean.LawList
...
class LawListRemoteMediator(
    private val query: String,
    private val category: String,
    private val database: ListBeanDatabase,
    private val apiService: ApiService
) : RemoteMediator<Int, LawList>() {
    private val listBeanDao = database.lawListDao()
    ...
    override suspend fun load(
        ...
        return try {
            ...
            val response = apiService.getLawData(category, "${loadKey}")
