...
import com.example.sjzs.model.bean.LifeList
...
class LifeListRemoteMediator(
    private val query: String,
    private val category: String,
    private val database: ListBeanDatabase,
    private val apiService: ApiService
) : RemoteMediator<Int, LifeList>() {
    private val listBeanDao = database.lifeListDao()
    ...
    override suspend fun load(
        loadType: LoadType,
        state: PagingState<Int, LifeList>
    ): MediatorResult {
        return try {
            ...
            val response = apiService.getLifeData(category, "${loadKey}")
