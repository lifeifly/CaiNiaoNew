...
import com.example.sjzs.model.bean.TechList
...
class TechListRemoteMediator(
    private val query: String,
    private val category: String,
    private val database: ListBeanDatabase,
    private val apiService: ApiService
) : RemoteMediator<Int, TechList>() {
    private val listBeanDao = database.techListDao()
    ...
    override suspend fun load(
        loadType: LoadType,
        state: PagingState<Int, TechList>
    ): MediatorResult {
        return try {
            ...
            val response = apiService.getTechData(category, "${loadKey}")
