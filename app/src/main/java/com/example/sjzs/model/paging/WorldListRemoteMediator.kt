...
class WorldListRemoteMediator(
    private val query: String,
    private val category: String,
    private val database: ListBeanDatabase,
    private val apiService: ApiService
) : RemoteMediator<Int, WorldList>() {
    private val listBeanDao = database.worldListDao()
    ...
    override suspend fun load(
        loadType: LoadType,
        state: PagingState<Int, WorldList>
    ): MediatorResult {
        return try {
            ...
            val response = apiService.getWorldData(category, "${loadKey}")
